...
# Date: Fri, 27 Apr 2018 16:50:24 GMT
#set_units -time ns
...
create_generated_clock -name {UART_3_IntClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 313 627} [list [get_pins {ClockBlock/dclk_glb_0}]]
...
create_generated_clock -name {Clock_2} -source [get_pins {ClockBlock/clk_sync}] -edges {1 523 1045} [list [get_pins {ClockBlock/dclk_glb_2}]]
...
# Project: C:\Users\Lenovo\Documents\GitHub\Mepsan\Mepsan.cydsn\Mepsan.cyprj
# Date: Fri, 27 Apr 2018 16:50:04 GMT
