...
uint8 msn_EDS[32]       = "       EDS LA PROVIDENCIA       ";
uint8 msn_EDS2[32]      = "          OMAR MALAGON          ";
uint8 msn_EDS0[32]      = "      JUAN ELIECER CORTES       "; //No va//
uint8 msn_EDS3[32]      = "         Nit: 4172693-6         ";
uint8 msn_EDS4[32]      = "         Tel: 3208669161        "; 
uint8 msn_EDS5[32]      = "      KM 2 VIA Sutamarchan      ";
uint8 msn_EDS6[32]      = "        TINJACA - BOYACA        ";
